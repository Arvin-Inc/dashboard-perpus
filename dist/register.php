...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $cekemail = mysqli_query($conn, "SELECT * FROM user WHERE gmail = '$email'");
...
<head>
    ...
    <title>Register User - SB Admin</title>
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="register.php" method="post">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputUsername" type="text" placeholder="name@example.com" name="username" />
                                ...
                                <div class="card-footer text-center py-3">
                                    ...
                                    <div class="small"><a href="register1.php">register anggota</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
