...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $cekbuku = mysqli_query($conn, "SELECT * FROM buku WHERE judul = '$judul'");

    if (mysqli_num_rows($cekbuku) > 0) {
        echo "<script>
                alert('Buku dengan judul tersebut sudah terdaftar');
                window.location='tambah-buku.php';
              </script>";
    } else {
        $query = mysqli_query($conn, 
            "INSERT INTO buku (judul, pengarang, tahun_terbit) VALUES ('$judul', '$pengarang', '$tahun_terbit')"
        );

        if ($query) {
            echo "<script>
                    alert('Buku berhasil ditambahkan');
                    window.location='Tampilan-buku.php';
                  </script>";
        } else {
            echo "<script>
                    alert('Gagal menambahkan buku');
                    window.location='Tambah-bukup.php';
                  </script>";
        }
    }
