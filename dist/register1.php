...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($cekemail) > 0) {
        ...
        $query = mysqli_query($conn, "INSERT INTO anggota (nama_anggota, alamat, jk, gmail, pass, username, role) VALUES ('$nama', '$alamat', '$jk', '$email', '$password', '$username', 'anggota')");
        if ($query) {
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Register Anggota</h3>
                                </div>
                                <div class="card-body">
                                    <form action="register1.php" method="post">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputName" type="text" placeholder="Masukan Nama" name="nama" />
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputEmail" type="text" placeholder="Masukan Alamat" name="alamat" />
